...
public sealed class UpdateDiscountCommandHandler : IRequestHandler<UpdateDiscountCommand, Result<CouponResponseDto>>
{
    ...
    public async Task<Result<CouponResponseDto>> Handle(UpdateDiscountCommand request, CancellationToken cancellationToken)
    {
